...
- 297 complete, legally replayed games were reused.
- 7128 game-turn rows were reconstructed.
- 292248 point-turn states matched Piece counts.
- 12177 point state chains were continuous.
- 297 final 41-point boards matched source evidence.
- 297 winners were reproduced from the three lexicographic components.
- 10223 Objective Supply-source uses were checked.
